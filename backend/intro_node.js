...
## Installing Modules: NPM

With npm we can start a project and download libraries
...
The above command starts a `project.json` file.
...
To get started making command line applications we can do the [following](https://github.com/anseki/readline-sync):
