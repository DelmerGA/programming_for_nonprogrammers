...
| To list basic datatypes |
| To explain the use cases and methods for datatypes |
...
* **1995** Created in 10 days in May 1995 by Brendan Eich.
![Brendan Eich](http://queerty-prodweb.s3.amazonaws.com/wp/docs/2014/04/brendan-eich1.jpg)

It's been in development since then.

## Adding JS To You Project

In your project you can either use a set of `<script></script>` tags to write your javascript.
...
or by writing it in file with the extenstion `.js`.
...
and a `<script></script>` with a `src` attribute.
...
To open your interactive JavaScript console you just press and hold
